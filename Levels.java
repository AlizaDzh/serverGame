...
public class Levels implements Serializable {
    ...
    public int[][] getFourthLevel() {
        String path = "src/images/levels/level4.txt";
    ...
    public int[][] getFifthLevel() {
        String path = "src/images/levels/level5.txt";
        int[][] fifthLevel = null;
        File file = new File(path);
        String contentFromFile = null;
        try {
    ...
    public int[][] getSixthLevel() {
        String path = "src/images/levels/level6.txt";
        int[][] sixthLevel = null;
        File file = new File(path);
        String contentFromFile = null;
        try {
    ...
    public int[][] getLevelFromServer(String getLevel) {
        try (Socket socket = new Socket(HOST, PORT);
            ...
            int[][] desktopFromServer = serverDesktop.getLevel();
